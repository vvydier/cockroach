...
type (
	// RangeTree how you get access to the range tree.
	RangeTree proto.RangeTree
	// RangeTreeNode represents a node in the range tree, each range
	// has a single node.
...
func New() (*RangeTree, *error) {
	var rangeTree RangeTree
	rangeTree.Count = 0
...
func (t *RangeTree) SetRoot(r *RangeTreeNode) {
	t.root = r
}

// Root returns the root node of the tree.
func (t *RangeTree) Root() *RangeTreeNode {
